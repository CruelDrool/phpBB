...
$lang = array_merge($lang, array(
	...
	'RECAPTCHA_PUBLIC_EXPLAIN'		=> 'The public site key is used to load the widget. Keys can be obtained on <a href="//www.google.com/recaptcha">www.google.com/recaptcha</a>.',
	'RECAPTCHA_PRIVATE'				=> 'Secret key',
	'RECAPTCHA_PRIVATE_EXPLAIN'		=> 'The private secret key is for communication between your site and the reCAPTCHA verification server. Keys can be obtained on <a href="//www.google.com/recaptcha">www.google.com/recaptcha</a>.',

	'RECAPTCHA_ERROR_MESSAGE'				=> 'Error message',
	'RECAPTCHA_ERROR_MESSAGE_EXPLAIN'		=> 'In this textbox, you can type in a custom error message. Leave it empty to use the default one.',
	...
	'RECAPTCHA_REQUIRE_REMOTE_IP'			=> 'Require client\'s IP',
	'RECAPTCHA_REQUIRE_REMOTE_IP_EXPLAIN'	=> 'Require that the client\'s IP address has been determined before submitting data to the reCAPTCHA server. An undetermined IP address will be treated as a failed CAPTCHA attempt.',
	...
	'RECAPTCHA_V3_ACTION_DEFAULT'			=> 'Default',
	'RECAPTCHA_V3_ACTION_DEFAULT_EXPLAIN'	=> 'Used when none of the other actions are applicable.',
	'RECAPTCHA_V3_ACTION_LOGIN'				=> 'Login',
	'RECAPTCHA_V3_ACTION_POST'				=> 'Post',
	'RECAPTCHA_V3_ACTION_REGISTER'			=> 'Register',
	'RECAPTCHA_V3_ACTION_REPORT'			=> 'Report',
	'RECAPTCHA_V3_ACTIONS'					=> 'Actions',
	'RECAPTCHA_V3_ACTIONS_EXPLAIN'			=> 'Action names may only contain alphanumeric characters, underscores, and forward slashes.',	

	'RECAPTCHA_V3_THRESHOLD_DEFAULT'			=> 'Default',
	'RECAPTCHA_V3_THRESHOLD_DEFAULT_EXPLAIN'	=> 'Used when none of the other actions are applicable.',
	'RECAPTCHA_V3_THRESHOLD_LOGIN'				=> 'Login',
	'RECAPTCHA_V3_THRESHOLD_POST'				=> 'Post',
	'RECAPTCHA_V3_THRESHOLD_REGISTER'			=> 'Register',
	'RECAPTCHA_V3_THRESHOLD_REPORT'				=> 'Report',
